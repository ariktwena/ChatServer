...
public class Game {
    ...
    private volatile Client2 winner;
    ...
    public void play(GameParticipant participant) throws InterruptedException {
        ...
        Client2 winner = getAndSetWinner(participant.getClient());
    ...
    public synchronized Client2 getAndSetWinner(Client2 client) {
        if (winner == null) {
            winner = client;
        }
        return winner;
    ...
    public static interface GameParticipant {
        ...
        void notifyWinner(Client2 client);
        String getAnswer();
        Client2 getClient();
    }
}
